...
export default function MainContainer() {
  ...
  const processAllNotes = async () => {
    ...
    const summaryPrompt = `Summarize the following notes: ${combinedNotes} 
    Return the answer in the following JSON format: 
    {
       "title": "title generated by gemini api",
       "content": "notes generated by gemini api"
    }
       ALWAYS RETURN JSON without any formmating just plain json text
      `;
